...
class BloxorzSuite extends FunSuite {
  ...
  test("terrain function level 0 negative") {
    new Level0 {
  ...
  test("terrain function level 0 out of bound") {
    new Level0 {
      assert(!terrain(Pos(1,1)), "1,1")
  ...
  test("terrain function level 1 out of bound") {
    new Level1 {
      assert(!terrain(Pos(1,10)), "0,10")
